...
This module uses L<Algorithm::Networksort> to compute sorting networks. This presentation explains what sorting networks are: L<Introduction To Sorting Networks|http://hoytech.github.com/sorting-networks/>
...
Also optimise by average swaps assuming uniform input using combinatoric analysis
...
What are sorting networks? L<Introduction To Sorting Networks|http://hoytech.github.com/sorting-networks/>
